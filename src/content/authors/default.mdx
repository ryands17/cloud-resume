...
In my spare time, I write blogs [here](https://ryan17.dev/blog/) and on [Dev Community](https://dev.to/ryands17/) on things like React, Node, Rust, and AWS. I hope to help others with these posts so that they get an easy way of doing the things that I experienced.

This portfolio is deployed on a VM using [Hetzner](https://www.hetzner.com/) and Docker Compose. This is served via [Caddy](https://caddyserver.com/) with [Cloudflare](https://www.cloudflare.com/) as a CDN.
